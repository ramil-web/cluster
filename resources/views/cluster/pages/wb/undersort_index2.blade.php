...
@section('content')
    ...
    <div class="wb-undersort-index" id="main_content_wrapper">
        ...
        {{--<h1 class="main-title">Подсортировка</h1>--}}
        ...
        @if($show_items)
            ...
            @else
                <div class="panel panel-info" style="margin-top: 15px">
                    <div class="panel-heading">Выгрузка {{$base_date_start}} - {{$base_date_end}}</div>
                    <div class="panel-body">

                        <a href="/undersort?undersort_start=1&date_start={{$base_date_start}}&date_end={{$base_date_end}}">
                            <button class="btn btn-success btn-block">
                                Выгрузить подсортировку
                            </button>
                        </a>
            ...
            @else
                <div class="panel panel-info" style="margin-top: 15px">
                    <div class="panel-heading">Готовые подсортировки. Выгрузка в XML.</div>
                    <div class="panel-body">

                        <div class="row">
                            @foreach( $undersorts_for_xml as $item)
                                <div class="col-md-4" style="margin-bottom: 10px">
                                    <a href="/undersort?undersort_xml_start=1&undersort_id={{$item->getId()}}">
                                        <button class="btn btn-success btn-block">
            ...
            <div class="panel panel-info" style="margin-top: 15px">
                <div class="panel-heading">Готовые выгрузки в XML. Скачать.</div>
                <div class="panel-body">

                    <div class="row">
                        @foreach( $undersorts_for_xml as $item)

                            @if(file_exists('files/undersort_xml/' . $item->getAlias()))

                                <div class="col-md-4" style="margin-bottom: 10px">
                                    <a href="/files/undersort_xml/{!! $item->getAlias() !!}"
                                       download
                                       target="_blank">
