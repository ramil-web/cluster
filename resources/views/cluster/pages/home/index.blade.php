...
@section('content')
    ...
    <div id="main_content_wrapper">
        ...
        <div class="container">
            ...
            <div class="form-group clearfix{{ $errors->has('login') ? ' has-error' : '' }}">
                <label for="login" class="col-md-12 control-label">Логин</label>

                <div class="col-md-12">
                    <input id="main_page" type="hidden" name="main_page" value="1">
